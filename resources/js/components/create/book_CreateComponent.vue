...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      // Vous pouvez ajouter d'autres appels axios pour récupérer les données supplémentaires nécessaires pour votre formulaire de livre
    },
