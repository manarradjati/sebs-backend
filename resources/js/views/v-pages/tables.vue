<script setup>
import DemoSimpleTableBasics from '@/views/g-pages/tables/DemoSimpleTableBasics.vue'
import DemoSimpleTableDensity from '@/views/g-pages/tables/DemoSimpleTableDensity.vue'
import DemoSimpleTableFixedHeader from '@/views/g-pages/tables/DemoSimpleTableFixedHeader.vue'
import DemoSimpleTableHeight from '@/views/g-pages/tables/DemoSimpleTableHeight.vue'
import DemoSimpleTableTheme from '@/views/g-pages/tables/DemoSimpleTableTheme.vue'
</script>
